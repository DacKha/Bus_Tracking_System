-- ============================================
-- RESET DATABASE - Xóa và tạo lại toàn bộ schema
-- Smart School Bus Tracking System
-- ============================================

-- Xóa database nếu tồn tại
DROP DATABASE IF EXISTS ssb_db;

-- Tạo database mới
CREATE DATABASE ssb_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- ============================================
-- LƯU Ý: File seed.sql chứa dữ liệu mẫu để testing
-- Reset.sql chỉ tạo schema, không có data
-- ============================================
